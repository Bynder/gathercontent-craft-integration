...
namespace gathercontent\gathercontent\widgets;

use gathercontent\gathercontent\Gathercontent;
use gathercontent\gathercontent\assetbundles\testwidget\TestWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * gathercontent Widget
 *
...
class Test extends Widget
{
    ...
    {
        return Craft::getAlias("@gathercontent/gathercontent/assetbundles/testwidget/dist/img/Test-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'gathercontent/_components/widgets/Test_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(TestWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'gathercontent/_components/widgets/Test_body',
            [
