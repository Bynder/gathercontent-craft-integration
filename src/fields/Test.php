...
namespace gathercontent\gathercontent\fields;

use gathercontent\gathercontent\Gathercontent;
use gathercontent\gathercontent\assetbundles\testfield\TestFieldAsset;
...
class Test extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'gathercontent/_components/fields/Test_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(TestFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').GathercontentTest(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'gathercontent/_components/fields/Test_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
